"""Switches related to SmartX-RTS-HA."""
        ...
        for shade in controller.api.shades:
            try:
                if "shadeType" in shade and (
                    ...
                    new_entities.append(
                        SmartXBinarySwitch(controller=controller, data=shade)
                    )
                elif "sunSensor" in shade:
                    if shade["sunSensor"] is True:
                        new_entities.append(
                            SmartXSunSwitch(controller=controller, data=shade)
                        )
            ...
            try:
                if "sunSensor" in group:
                    if group["sunSensor"] is True:
                        new_entities.append(
                            SmartXSunSwitch(controller=controller, data=group)
                        )
...
class SmartXSunSwitch(SmartXEntity, SwitchEntity):
...
class SmartXBinarySwitch(SmartXEntity, SwitchEntity):
