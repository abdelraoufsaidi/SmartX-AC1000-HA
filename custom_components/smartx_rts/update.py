"""Support for SmartX RTS updates."""
...
async def async_setup_entry(
    ...
    if "serverId" in data:
        async_add_entities([SmartXRTSUpdateEntity(controller)])


class SmartXRTSUpdateEntity(SmartXEntity, UpdateEntity):
    """Defines an SmartX RTS update entity."""
    ...
    _attr_title = "SmartX RTS Firmware"

    def __init__(self, controller: SmartXController) -> None:
